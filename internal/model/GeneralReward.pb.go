...
type GeneralReward struct {
	...
	Type     int32  `protobuf:"varint,2,opt,name=type,proto3" json:"type,omitempty"`        //类型  1-talk消息  2-ping/pong  3-exit消息 4-登陆 5-userlist消息
	Username string `protobuf:"bytes,3,opt,name=username,proto3" json:"username,omitempty"` //发送者
	Ext      string `protobuf:"bytes,4,opt,name=ext,proto3" json:"ext,omitempty"`           // 扩展字段，IAP使用
}
...
func (x *GeneralReward) GetType() int32 {
	if x != nil {
		return x.Type
	}
	return 0
...
func (x *GeneralReward) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
var file_GeneralReward_proto_rawDesc = []byte{
	...
	0x63, 0x0a, 0x0d, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x6c, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64,
	0x12, 0x10, 0x0a, 0x03, 0x6d, 0x73, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d,
	0x73, 0x67, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05,
	...
	0x03, 0x65, 0x78, 0x74, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x6d, 0x6f, 0x64, 0x65, 0x6c,
...
var file_GeneralReward_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
